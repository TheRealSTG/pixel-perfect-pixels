...
export const Rose: React.FC<FlowerProps> = ({
  ...
  // Flat: fully opaque petals for bold poster look
  const outerOp = style === "flat" ? 1   : style === "watercolour" ? 0.72 : 0.82;
  const midOp   = style === "flat" ? 1   : 0.85;
  return (
        ...
        <>
          ...
          {[0,72,144,216,288].map((angle, i) => (
            <path key={angle}
              ...
              fill={`url(#${id}-g)`}
              transform={`rotate(${angle})`} opacity={outerOp}
          ...
          {[36,108,180,252,324].map((angle) => (
            <path key={angle}
              ...
              fill={`url(#${id}-inner)`}
              transform={`rotate(${angle})`} opacity={midOp} />
          ))}
          <path d="M -1.5 -1 Q -2 -3.5,0 -4.5 Q 2 -3.5,1.5 -1 Q 0.5 0.5,-1.5 -1"
            fill={accentColor} opacity={style === "flat" ? 1 : 0.9} />
          <ellipse cx="-2" cy="-5" rx="1.5" ry="2.5" fill="white" opacity={0.14}
            transform="rotate(-20,-2,-5)" />
        </>
      )}
    </g>
  );
...
export const Peony: React.FC<FlowerProps> = ({
  ...
  const outerOp = style === "flat" ? 0.9 : 0.58;
  const innerOp = style === "flat" ? 1.0 : 0.70;
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        <>
        ...
        <>
          ...
          {[20,65,110,155,200,245,290,335].map((angle) => (
            <path key={`i-${angle}`}
              ...
              fill={accentColor} transform={`rotate(${angle})`} opacity={innerOp}
              stroke={style === "botanical" ? shadeColor(accentColor,-20) : "none"} strokeWidth={0.25} />
          ))}
          {[0,90,180,270].map((a) => (
            <path key={`c-${a}`}
              d="M 0 0 Q -1.5 -1.5,-1 -4 Q 0 -5,1 -4 Q 1.5 -1.5,0 0"
              fill={color} transform={`rotate(${a})`} opacity={style === "flat" ? 1 : 0.9} />
          ))}
          <circle cx="0" cy="-0.5" r="2" fill="#F0D8A8" opacity={0.45} />
          <ellipse cx="1.5" cy="-4" rx="1" ry="2" fill="white" opacity={0.12}
            transform="rotate(-15,1.5,-4)" />
        </>
      )}
    </g>
  );
...
export const Tulip: React.FC<FlowerProps> = ({
  ...
  const centerOp = style === "flat" ? 1 : 0.7;
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        <>
        ...
        <>
          ...
          <path d="M -4 5 Q -5 -4,-1 -14 Q 0 -16,1 -14 Q 5 -4,4 5 Z"
            fill={accentColor} opacity={centerOp} />
          <path d="M -3 2 Q -4 -4,-3 -10" stroke={dark} strokeWidth={0.25} fill="none" opacity={0.3} />
          <path d="M 3 2 Q 4 -4,3 -10"   stroke={dark} strokeWidth={0.25} fill="none" opacity={0.3} />
          <path d="M -4 -2 Q -5 -6,-4 -10" stroke="white" strokeWidth={0.8} fill="none"
...
export const Sunflower: React.FC<FlowerProps> = ({
  ...
  const light = shadeColor(color, 30);
  const petalOp = style === "flat" ? 1 : 0.88;
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        <>
        ...
        <>
          ...
          {Array.from({length:18}).map((_,i) => {
            ...
            return (
              <path key={i}
                d={`M 0 0 Q ${-2.5-w} ${-5},${-2} ${-12-w} Q 0 ${-15-w},${2} ${-12-w} Q ${2.5+w} ${-5},0 0`}
                fill={`url(#${id}-pg)`}
                transform={`rotate(${a})`}
          ...
          {Array.from({length:14}).map((_,i) => {
            ...
            return (
              <path key={`inner-${i}`}
                ...
                fill={accentColor} transform={`rotate(${a})`}
                opacity={style==="flat"?1:0.75} />
            );
          })}
          ...
          <ellipse cx="-2" cy="-2" rx="2" ry="2.5" fill="white" opacity={0.09} />
        </>
      )}
    </g>
  );
  ...
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        ...
        <>
          <path d="M 0 5 Q -1 14,1 26 Q 2 34,0 42"
            stroke="#6BA06B" strokeWidth={style==="botanical"?1:1.3}
            fill="none" strokeLinecap="round" />
          {[-15,-12,-9,-6,-3,0].map((py,i) => {
            const sz = 1.2+(5-i)*0.25;
            const op = style === "flat" ? 1 : 0.85;
            return (
              <React.Fragment key={py}>
                <path d={`M -0.5 ${py} Q ${-sz*2} ${py-1},${-sz*2.2} ${py-0.5} Q ${-sz*2} ${py+1},-0.5 ${py}`}
                  fill={i%2===0?color:light} opacity={op}
                  stroke={style==="botanical"?dark:"none"} strokeWidth={0.25} />
                <path d={`M 0.5 ${py} Q ${sz*2} ${py-1},${sz*2.2} ${py-0.5} Q ${sz*2} ${py+1},0.5 ${py}`}
                  fill={i%2===0?accentColor:color} opacity={op}
                  stroke={style==="botanical"?dark:"none"} strokeWidth={0.25} />
...
export const Eucalyptus: React.FC<FlowerProps> = ({
  ...
  const leafOp = style === "flat" ? 0.95 : 0.70;
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        <>
        ...
        <>
          <path d="M 0 -12 Q -2 4,1 20 Q 2 30,0 38"
            stroke={accentColor} strokeWidth={style==="botanical"?1:1.3}
            fill="none" strokeLinecap="round" />
          {[-10,-4,2,8,14,20,26].map((py,i) => {
            ...
            return (
              <g key={py}>
                <ellipse cx={side*5} cy={py} rx={4.2} ry={3.5}
                  fill={fill} opacity={leafOp}
...
export const Daisy: React.FC<FlowerProps> = ({
  ...
  const id = `daisy-${x}-${y}`;
  const petalOp = style === "flat" ? 1 : 0.9;
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        <>
        ...
        <>
          ...
          {Array.from({length:14}).map((_,i) => {
            ...
            return (
              <path key={i}
                d={`M 0 0 Q ${-2-w} ${-4},${-1.5} ${-9} Q 0 ${-11},1.5 ${-9} Q ${2+w} ${-4},0 0`}
                fill={color} transform={`rotate(${a})`}
                stroke={style==="botanical"?"#DDD":"none"} strokeWidth={0.3}
                opacity={petalOp} />
            );
          })}
          ...
          {Array.from({length:10}).map((_,i) => {
            ...
            const r  = 1.5+(i%3)*0.5;
            return <circle key={i} cx={Math.cos(a2)*r} cy={Math.sin(a2)*r}
              r={0.35} fill="#D4A020" opacity={0.5} />;
          })}
        </>
      )}
    </g>
...
export const Hyacinth: React.FC<FlowerProps> = ({
  ...
  const floretOp = style === "flat" ? 1 : 0.8;
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        <>
        ...
        <>
          <path d="M 0 6 Q -1 18,1 32 Q 2 38,0 44"
            stroke="#6BA06B" strokeWidth={style==="botanical"?2:2.8}
            fill="none" strokeLinecap="round" />
...
export const Ranunculus: React.FC<FlowerProps> = ({
  ...
  const dark  = shadeColor(color, -25);
  const light = shadeColor(color, 30);
  const outerOp = style === "flat" ? 0.85 : 0.48;
  const midOp   = style === "flat" ? 0.95 : 0.60;
  const innerOp = style === "flat" ? 1    : 0.85;
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        <>
        ...
        <>
          ...
          {[0,45,90,135,180,225,270,315].map((a) => (
            <path key={`o3-${a}`}
              ...
              fill={`url(#${id}-g)`} transform={`rotate(${a})`} opacity={outerOp}
              stroke={style==="botanical"?dark:"none"} strokeWidth={0.25} />
          ))}
          {[22,67,112,157,202,247,292,337].map((a) => (
            <path key={`o2-${a}`}
              d="M 0 0 Q -3.5 -3,-3 -7.5 Q 0 -9.5,3 -7.5 Q 3.5 -3,0 0"
              fill={accentColor} transform={`rotate(${a})`} opacity={midOp}
              stroke={style==="botanical"?dark:"none"} strokeWidth={0.2} />
          ))}
          {[0,60,120,180,240,300].map((a) => (
            <path key={`o1-${a}`}
              d="M 0 0 Q -2 -2,-1.5 -5 Q 0 -6.5,1.5 -5 Q 2 -2,0 0"
              fill={color} transform={`rotate(${a})`} opacity={innerOp} />
          ))}
...
export const CherryBlossom: React.FC<FlowerProps> = ({
  ...
  const dark  = shadeColor(color, -20);
  const light = shadeColor(color, 30);
  const petalOp = style === "flat" ? 1 : 0.85;
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        <>
        ...
        <>
          ...
          {[0,72,144,216,288].map((a) => (
            <line key={`v-${a}`} x1="0" y1="0" x2="0" y2="-6"
              stroke={dark} strokeWidth={0.2} transform={`rotate(${a})`} opacity={0.2} />
          ))}
          {[0,60,120,180,240,300].map((a) => (
...
export const BabysBreath: React.FC<FlowerProps> = ({
  ...
  <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
    {style === "pixel" ? (
      ...
      <>
        <path d="M 0 4 Q -1 12,0 30" stroke="#8AA878" strokeWidth={0.8}
          fill="none" strokeLinecap="round" />
        {[
  ...
  return (
    <g transform={`translate(${x},${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        ...
        <>
          <path d="M 0 -14 Q -1 4,1 22 Q 2 30,0 38"
            stroke={accentColor} strokeWidth={1.2} fill="none" strokeLinecap="round" />
            ...
            return (
              <g key={py}>
                <path
                  ...
                  fill={i<4?light:color} opacity={leafOp}
                ...
                {length>4 && (
                  <>
                    <path d={`M ${side*length*0.4} ${py-1} Q ${side*length*0.5} ${py-3},${side*length*0.6} ${py-2.5} Q ${side*length*0.5} ${py-0.5},${side*length*0.4} ${py-1}`}
                      fill={color} opacity={style==="flat"?0.8:0.5} />
                    <path d={`M ${side*length*0.6} ${py-1.5} Q ${side*length*0.7} ${py-3.5},${side*length*0.85} ${py-3} Q ${side*length*0.75} ${py-1},${side*length*0.6} ${py-1.5}`}
                      fill={color} opacity={style==="flat"?0.75:0.45} />
                  </>
                )}
