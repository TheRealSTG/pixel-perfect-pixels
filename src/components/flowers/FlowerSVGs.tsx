  ...
  return (
    <g transform={`translate(${x}, ${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        ...
        <>
          {/* Stem kept — eucalyptus IS stem + leaves, no separate bloom */}
...
export const BabysBreath: React.FC<FlowerProps> = ({
  ...
  <g transform={`translate(${x}, ${y}) rotate(${rotation}) scale(${scale})`}>
    {style === "pixel" ? (
      ...
      <>
        {/* Delicate branching — stem kept as it IS the structure */}
  ...
  return (
    <g transform={`translate(${x}, ${y}) rotate(${rotation}) scale(${scale})`}>
      {style === "pixel" ? (
        ...
        <>
          {/* Central frond — stem IS the structure */}
